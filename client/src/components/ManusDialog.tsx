...
export function ManusDialog({
  ...
  return (
    ...
    >
        <DialogContent className="py-5 bg-card text-card-foreground rounded-[20px] w-[400px] shadow-[0px_4px_11px_0px_rgba(0,0,0,0.08)] border border-border backdrop-blur-2xl p-0 gap-0 text-center">
